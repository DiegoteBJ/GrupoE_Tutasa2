...
namespace GrupoE_Tutasa.FormularioPrincipal
{
    ...
    {
        public static int agenciaTrabajoId = 26; // ID de la agencia de trabajo, se puede cambiar según sea necesario
        public static int CDTrabajoId = 5; // ID del centro de distribución de trabajo, se puede cambiar según sea necesario
